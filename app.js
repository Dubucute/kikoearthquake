(function() {
  ...
  const JAVI_REACTIONS = [
    ...
    "Skibidi bop mm dada! 🕺",
    "Rizz mo 'yan, bes! 🔥",
    "Gyatt! Ang laki ng… charm mo! 😳",
    "Sigma ka ba? Kasi grind ka nang grind! 💪",
    "No cap, ang galing mo! 🧢❌",
    "Skibidi toilet ka ba? Kasi you flush me away! 🚽😭",
    "Fanum tax 'yan, bes! 🫵",
    "Ohio skibidi! 🏀",
    "Rizzler level 100! 📈",
    "NPC ka ba? Kasi lagi kang naka-stand by! 🎮",
    "Main character energy 'yan! 🌟",
    "Sus sus sus! Amogus! 🕵️",
    "Brainrot yarn? 🧠💀",
    "Skibidi dop dop yes yes! 🎵",
    "Mewing ka ba? 👁️👅👁️",
    "Looksmaxxing yarn? 💅",
    "Sigma grindset: mag-monitor ng lindol! 📊",
    "Rizz mo yan, bes! Walang laban! 🏆",
    "Gyatt dayumn! 😩",
    "Skibidi rizzler sa ere! 📡",
    "Ohio final boss yarn? 👑",
    "NPC behavior 'yan! 🤖",
    "Brainrot detected! 🧟",
    "Sus imposter yarn? 🚨",
    "Skibidi battle pass! 🎮",
    "Mewing streak: 69 days! 😏",
    "Looksmaxxing to sigma! 💫",
    "Rizz god yarn? 🙏",
    "Gyatt level: earthquake! 🌍💥",
    "Skibidi dop dop, lindol yan! 🌊",
    "No cap, may lindol! 🧢❌",
    "Sigma rule #1: laging handa! 📋",
    "Rizz mo 'yan, Javi approved! ✅",
    "Brainrot pero cute! 🥴",
    "Skibidi toilet alert! 🚽⚠️",
    "Ohio moment yarn? 🤔",
    "NPC: nag-eearthquake! 🎮🌍",
    "Sus sa aftershock! 🕵️",
    "Gyatt na lindol! 😩🌊",
    "Mewing while earthquake! 👁️👅👁️🌍",
    "Rizzler ng Quake Buddy! 🏆",
    "Sigma grindset: mag-evacuate! 🏃",
    "Skibidi bop, ingat lagi! 🫡",
    "Brainrot: DROP COVER HOLD ON! 🧠💀",
    "Looksmaxxing sa safe zone! 🛡️",
    "Rizz mo 'yan, beshie! 💕",
    "Gyatt dayumn, ang lindol! 😩🌋",
    "No cap, maghanda na tayo! 🧰",
    "Skibidi sigma alert! 🚨",
    "NPC behavior: mag-panic! 😱",
    "Sus yarn sa evacuation! 🏃",
    "Rizzler ng emergency kit! 🎒",
    "Brainrot pero safe! 🧠✅",
    "Ohio skibidi, Javi out! 🎤",
    "Mewing while waiting! 👁️👅👁️⏳",
    "Sigma rule #69: laging naka-charge! 🔋",
    "Gyatt na gyatt! 😩💀",
    "Skibidi dop dop, thank you! 🙏",
    "Rizz mo 'yan, walang iwanan! 🤝",
    "Brainrot family yarn? 👨‍👩‍👧‍👦🧠",
    "No cap, mahal ko kayo! 💗",
    "Skibidi out! 🕺",
  ];
