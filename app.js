(function() {
  ...
  const JAVI_REACTIONS = [
    "Hoy! 'wag mo 'kong pindot-pindot yarn",
    "Aray! Masakit yarn",
    "Haha, ano yarn",
    "Ingat lagi, bes",
    "Earthquake yarn? Ako na bahala",
    "Bakit? Miss mo ko yarn",
    "Sige, isa pa! Pindot ulit yarn",
    "Busy ako mag-monitor ng lindol",
    "Loko-loko ka yarn",
    "Alam mo ba kung gaano kahirap maging bantay-lindol",
    "Wag kang mag-alala, nandito lang ako",
    "Salamat sa pagpindot! Sana masarap ulam mo",
    "Pindot ka nang pindot, wala namang lindol yarn",
    "Javi, laging handa",
    "Mahal kita pero wag mong saktan yarn",
    "Okay lang yarn, nandito si Javi",
    "Hoy! Respeto naman sa character ko yarn",
    "Ang cute ko diba yarn",
    "Sige lang, kaya pa yarn",
    "Bakit ka nandito? May lindol ba yarn",
    "Ang kulit mo yarn",
    "Tama na please yarn",
    ...
    "Ang saya saya yarn",
    "Miss na kita yarn",
    "Sana all masaya yarn",
    "Wag kang maingay yarn",
    "Javi is watching you yarn",
    "Ang init init yarn",
    "Penge naman ice cream yarn",
    "Sana bumagyo na yarn",
    "Ang boring naman yarn",
    "Gising gising yarn",
    "Kape muna bago lindol yarn",
    "Sana walang lindol today yarn",
    "Ingat sa byahe yarn",
    "Mahal kita yarn",
    "Sana masarap ulam mo lagi yarn",
    "Ang galing mo mag-pindot yarn",
    "Isa pa ulit yarn",
    "Hoy tawa naman dyan yarn",
    "Ang cute ng araw na to yarn",
    "Sana happy ka yarn",
    "Javi loves you yarn",
    "Wag kang mag-alala, andito ako yarn",
    "Ang sarap ng buhay yarn",
    "Sana all may Javi yarn",
    "Ang galing ko diba yarn",
    "Salamat sa support yarn",
    "Laban lang yarn",
    "Kaya mo yan yarn",
    "Wag kang susuko yarn",
    "Ang ganda ng araw yarn",
    "Sana masarap tulog mo yarn",
    "Good vibes lang yarn",
    "Ang saya ng pindot yarn",
    "Hoy ingat sa lindol yarn",
    "Javi alert lagi yarn",
    "Sana all naka-ready yarn",
    "Ang bilis ng kamay mo yarn",
    "Hoy bakit ka napadpad dito yarn",
    "Ang galing ng app na to yarn",
    "Sana all may earthquake app yarn",
    "Javi number one yarn",
    "Ang saya ng buhay yarn",
    "Sana all naka-install yarn",
    "Wag kalimutan mag-ready yarn",
    "Ang galing ng team natin yarn",
    "Sana all safe yarn",
    "Ingat palagi yarn",
    "Mahal ko kayo yarn",
    "Salamat sa pag-download yarn",
    "Ang galing ng Quake Buddy yarn",
    "Sana all may emergency kit yarn",
    "Hoy mag-stock ng tubig yarn",
    "Sana all may flashlight yarn",
    "Ang galing ng preparation yarn",
    "Javi approved yarn",
    "Sana all naka-charge yarn",
    "Wag kalimutan ang power bank yarn",
    "Ang galing ng community natin yarn",
    "Sana all may plano yarn",
    "Ingat sa aftershock yarn",
    "Javi nandito lang yarn",
    "Sana all may first aid kit yarn",
    "Ang galing ng teamwork yarn",
    "Mahal ko kayo lahat yarn",
    "Salamat sa tiwala yarn",
    "Ang saya ng pamilyang to yarn",
    "Sana all may JaviAlert yarn",
    "Hoy magdasal tayo yarn",
    "Ang galing ng Diyos yarn",
    "Sana all blessed yarn",
    "Javi out yarn",
    // ─── PICKUP LINES ─────────────────────────────────────────
    "Are you an earthquake yarn? Kasi you shook my world",
    "Bes, ang ganda mo naman yarn",
    "May mapa ka ba yarn? Kasi naliligaw ako sa mata mo",
    "Are you a fault line yarn? Kasi I'm falling for you",
    "Sakit ka sa ulo yarn… pero gusto pa rin kita",
    "Ang init mo yarn… parang lindol sa puso ko",
    "Are you a tsunami yarn? Kasi wave after wave ng feelings ko",
    "Pwede ba kitang i-rescue yarn? Kasi nakulong ako sa smile mo",
    "Earthquake ka ba yarn? Kasi ginigiba mo ang mundo ko",
    "Bes, may number ka ba yarn? Kasi I'd like to call you mine",
    "Ang galing mo mag-pindot yarn… pindotin mo rin puso ko",
    "Are you a 7.0 yarn? Kasi malakas tama mo sa akin",
    "Penge namang time mo yarn, kahit aftershock lang",
    "Ang cute mo yarn… parang safe zone sa puso ko",
    "Are you a PHIVOLCS yarn? Kasi lagi kitang mino-monitor",
    "Bes, may first aid ka ba yarn? Kasi nasaktan ako sa ganda mo",
    "Ang galing ng epicenter mo yarn… nasa puso ko",
    "Pwede ba maging emergency contact mo yarn? Para laging tawag ka lang",
    "Are you a red alert yarn? Kasi you make my heart race",
    "Bes, mag-evacuate na tayo yarn… sa puso ko",
    // ─── BRAINROT / SKIBIDI ────────────────────────────────────
    "Skibidi toilet yarn",
    "Fanum tax yarn, bes",
    "Ohio skibidi yarn",
    "Rizzler level 100 yarn",
    "Brainrot yarn",
    "Skibidi dop dop yes yes yarn",
    "Brainrot detected yarn",
    "Rizz god yarn",
    "Gyatt level earthquake yarn",
    "Skibidi dop dop, lindol yarn",
    "Skibidi toilet alert yarn",
    "Sus sa aftershock yarn",
    "Gyatt na lindol yarn",
    "Mewing while earthquake yarn",
    "Rizzler ng Quake Buddy yarn",
    "Sigma grindset mag-evacuate yarn",
    "No cap, maghanda na tayo yarn",
    "Skibidi sigma alert yarn",
    "Ohio skibidi, Javi out yarn",
    "Mewing while waiting yarn",
    "Sigma rule laging naka-charge yarn",
    "Skibidi dop dop, thank you yarn",
    "Rizz mo yarn, walang iwanan",
    "Brainrot family yarn",
    "No cap, mahal ko kayo yarn",
    // ─── MORE YARN FUNNY ───────────────────────────────────────
    ...
    "Ang weird mo yarn pero okay lang",
    "Seryoso yarn? Haha",
    "Okay lang yarn? Kasi okay lang ako yarn",
    "Ang funny mo yarn",
    "Tawang-tawa ako yarn",
    "Ang saya ko yarn kasi pinindot mo ko",
    "Salamat yarn! Sana all may pumipindot",
    "Ang boring ng araw ko yarn pero naging masaya",
    "Javi yarn, laging naka-standby yarn",
    "Earthquake yarn? Alert yarn!",
    "Ready yarn? Laging ready yarn",
    "Safe yarn? Oo safe yarn",
    "Ingat yarn? Oo ingat yarn",
    "Mahal yarn? Oo mahal yarn",
    "Bakit yarn? Kasi yarn",
    "Ano ba yarn? Ewan ko yarn",
    "Sabi ko yarn, wag kang mag-alala yarn",
    "Kaya yarn? Kaya yarn!",
    "Galing yarn? Galing yarn!",
    "Saya yarn? Saya yarn!",
    "Cute yarn? Cute yarn!",
    "Ganda yarn? Ganda yarn!",
    "Pogi yarn? Pogi yarn!",
    "Yarn yarn yarn!",
    "Yarnception yarn",
